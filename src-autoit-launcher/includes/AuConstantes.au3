...
Global $__SENHA_RUN 	 	 	 = BinaryToString("0x2D54545743435745524F4F4F414144434345494A494556454957455059524559575545495946484446484B4D4542424245595956564945505745525459")

Global $CHECK_EXE = True
Global $ATRACTMOD = (FileExists(@ScriptDir & "/" & "attract.ini"))? True : False
;~ if FileExists(@ScriptDir & "/" & "attract.ini") then $ATRACTMOD = True
	...
	If $ATRACTMOD Then
		$__READ_LOG_ADVMENU			= "attract.log"
		$__READ_EXE_ADVMENU			= "sdl.dll"
		$__READ_INI_ADVMENU			= "attract.ini"
		$__SENHA_RUN				= ""
		$CHECK_EXE 					= False
	EndIf
...
;ENCRYPT
;"Aadwe3@5AADQWIOCJOIKNJEEJASDBCUIBHWUW#@KH2923575e4twer56t445856797890456yh1rth1reh0"
Global $i__Obs1					 = BinaryToString("0x41616477653340354141445157494F434A4F494B4E4A45454A41534442435549424857555723404B48323932333537356534747765723536743434353835363739373839303435367968317274683172656830")

;SFASA#W@@OASJHOOI&*@#PNDI!@5$9%42256460ASf222556ADDD255666111ASFF90dfdfweW
Global $i__Obs2					 = BinaryToString("0x5346415341235740404F41534A484F4F49262A4023504E444921403524392534323235363436304153663232323535364144444432353536363631313141534646393064666466776557")

Global $O__GetSerial 	 	 	 = (IniRead(_CONST_ADVMENU_INI(), "KEY", "Serial", 0))


;SFAFIOHWIOURHWIUDFHA564DASD89AFSa65f4asAF4a6sf4aAFdf4w89WER4TGWED96G46AG46SDFG6W
Global Const $O__UserKey1	 	 = BinaryToString("0x53464146494F4857494F55524857495544464841353634444153443839414653613635663461734146346136736634614146646634773839574552345447574544393647343641473436534446473657")
;RGHREH455Y1456Y14565GH145655H1464551H46H1RT6H1RET6U145YU15561Y4365Y1465H1RTasa@
Global Const $O__UserKey2	 	 = BinaryToString("0x52474852454834353559313435365931343536354748313435363535483134363435353148343648315254364831524554365531343559553135353631593433363559313436354831525461736140252566666666")

Global Const $O__ENCRYPTKEY1 	 = $CALG_RC4
Global Const $O__ENCRYPTKEY2 	 = $CALG_AES_256
...
Func _CONST_REGIST_PAGE($i = False)
	...
	If $i Then
		...
		$O__GetSerial  = (String(IniRead(_CONST_ADVMENU_INI(), "KEY", "Serial", 0)))
		Return $sVar
	EndIf
...
;~ 	Else
;~ 		MostraMensa("O executavel selecionado não foi encontrado" & @LF & _
;~ 					"Por favor, use sempre os executaveis originais" & @LF & _
;~ 					"Telefone: " & $__TELEF & @LF & _
;~ 					$__FACE, 20000)
;~ 		Return
